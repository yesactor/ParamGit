...
<table border="0" cellpadding="5" cellspacing="1" class="table">
  ...
  <tr>
    ...
    <td class="right"><input type="text" name="data[site_path]" size="35" maxlength="50" value="{:get_site_path('index.php')}" id="data[site_path]" >&nbsp;&nbsp;<span>自动检测,结尾必需加斜杆 '/'</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="right"><input type="text" name="data[db_name]" id="data[db_name]" value="bibicms" size="35" maxlength="50" >&nbsp;&nbsp;<span>请填写已存在的数据库名</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="right"><input type="text" name="data[db_prefix]" id="data[db_prefix]" value="bb_" size="35" maxlength="50"  valid="required" errmsg="表前缀不能为空!">&nbsp;&nbsp;<span>密码尽量不要设为空</span></td>
  </tr>
</tbody>
</table>
